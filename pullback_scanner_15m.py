...
- EMA20/EMA50 상승 추세 + RSI 45~60 + 최근 고점대비 -5%~-12% + 거래량 건조
- GitHub Actions에서 30분마다 실행
- Telegram 알림: TG_BOT_TOKEN, TG_CHAT_ID (Secrets/Environment)
"""
...
# ===== 설정 =====
TICKER_FILE = "tickers.txt"     # 리포지토리 루트에 위치
INTERVAL = "15m"
PERIOD = "10d"
...
def scan_all() -> pd.DataFrame:
    ...
    # 덜 깊게 눌린 종목이 위로 오도록(낙폭 절댓값 작은 순)
